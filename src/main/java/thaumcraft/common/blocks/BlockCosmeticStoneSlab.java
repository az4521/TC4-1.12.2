...
public class BlockCosmeticStoneSlab extends BlockSlab {
   ...
   public static final PropertyEnum<BlockCosmeticStoneSlab.EnumType> VARIANT =
         PropertyEnum.create("variant", BlockCosmeticStoneSlab.EnumType.class);

   private final boolean doubleSlab;

   public BlockCosmeticStoneSlab(boolean doubleSlab) {
      super(Material.ROCK);
      ...
      this.setDefaultState(state.withProperty(VARIANT, EnumType.ARCANE));
   ...
   public void getSubBlocks(CreativeTabs tab, NonNullList<ItemStack> list) {
      if (this != ConfigBlocks.blockDoubleSlabStone) {
