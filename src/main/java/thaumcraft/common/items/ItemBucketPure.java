...
public class ItemBucketPure extends Item {
   ...
   public void registerIcons(IIconRegister ir) {
      this.icon = ir.registerSprite("thaumcraft:bucket_pure");
   }
   ...
   public boolean tryPlaceContainedLiquid(World world, int x, int y, int z) {
      ...
      if (!world.isAirBlock(new BlockPos(x, y, z)) && !flag) {
        ...
        world.setBlockState(new net.minecraft.util.math.BlockPos(x, y, z), (ConfigBlocks.blockFluidPure).getStateFromMeta(0), 3);
         return true;
      }
   }
}
