...
public class ComponentWizardTower extends StructureVillagePieces.Village {
   ...
   public ComponentWizardTower(StructureVillagePieces.Start par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
      ...
      this.setCoordBaseMode(EnumFacing.byIndex(par5));
   ...
   public static Object buildComponent(StructureVillagePieces.Start startPiece, List pieces, Random random, int par3, int par4, int par5, int par6, int par7) {
      StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 5, 12, 5, EnumFacing.byIndex(par6));
   ...
   public boolean addComponentParts(World world, Random par2Random, StructureBoundingBox bb) {
      ...
      this.fillWithBlocks(world, bb, 2, 0, 5, 4, 11, 5, Blocks.COBBLESTONE.getDefaultState(), Blocks.COBBLESTONE.getDefaultState(), false);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 1, 0, 1, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 1, 0, 5, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 5, 0, 1, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 5, 0, 5, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 1, 5, 1, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 1, 5, 5, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 5, 5, 1, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 5, 5, 5, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 1, 10, 1, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 1, 10, 5, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 5, 10, 1, bb);
      this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), 5, 10, 5, bb);
      ...
      for(int var5 = 1; var5 <= 9; ++var5) {
         this.setBlockState(world, Blocks.LADDER.getDefaultState().withProperty(BlockLadder.FACING, EnumFacing.WEST), 4, var5, 3, bb);
      }
      ...
      if (this.getBlockStateFromPos(world, 3, 0, 0, bb).getMaterial() == Material.AIR && this.getBlockStateFromPos(world, 3, -1, 0, bb).getMaterial() != Material.AIR) {
         this.setBlockState(world, Blocks.STONE_STAIRS.getDefaultState(), 3, 0, 0, bb);
      }
