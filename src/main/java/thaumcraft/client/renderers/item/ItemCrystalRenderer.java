...
public class ItemCrystalRenderer implements IItemRenderer {
   private final BlockCrystalRenderer blockRenderer = new BlockCrystalRenderer();
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      ...
      this.blockRenderer.renderInventoryBlock(ConfigBlocks.blockCrystal, item.getItemDamage(), ConfigBlocks.blockCrystalRI, new RenderBlocks());
