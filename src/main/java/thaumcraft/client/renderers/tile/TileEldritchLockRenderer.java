...
public class TileEldritchLockRenderer extends TileEntitySpecialRenderer<TileEntity> {
   ...
   public void render(TileEntity te, double x, double y, double z, float f, int destroyStage, float alpha) {
      ...
      EnumFacing dir = EnumFacing.byIndex(((TileEldritchLock)te).getFacing());

      for(int u = 0; u < 4; ++u) {
         GlStateManager.pushMatrix();
         GlStateManager.rotate(90 * u, dir.getXOffset(), dir.getYOffset(), dir.getZOffset());

         for(int a = 1; a < 5 - (((TileEldritchLock)te).count + u * 5) / 20; ++a) {
            GlStateManager.pushMatrix();
            GlStateManager.translate(0.0F, 0.25F + 0.5F * (float)a, 0.0F);
            float w = MathHelper.sin((count + (float)(a * 10) + (float)(u * 20)) / 20.0F) * 0.1F;
            if (a == 1 || a == 4) {
               w = w / 2.0F + 0.2F;
            }

            GlStateManager.scale((double)0.5F + (double)w, 0.5F, (double)0.5F + (double)w);
            this.model.render();
      ...
      if (((TileEldritchLock)te).count >= 0) {
         GlStateManager.pushMatrix();
         GlStateManager.translate((float)x + 0.5F + (float)dir.getXOffset() * 0.525F, (float)y + 0.285F, (float)z + 0.5F + (float)dir.getZOffset() * 0.525F);
         switch (dir.ordinal()) {
            case 2:
         ...
         if (this.entityitem == null) {
            this.entityitem = new EntityItem(te.getWorld(), 0.0F, 0.0F, 0.0F, this.is);
         }
   ...
   public void drawPlaneZPos(double x, double y, double z, float f, int height) {
      ...
      if (this.inrange) {
         for(int i = 0; i < 16; ++i) {
            ...
            buffer.pos(x - (double)2.0F, y + (double)3.0F, z + (double)offset);
            buffer.pos(x - (double)2.0F, y - (double)2.0F, z + (double)offset);
            buffer.pos(x + (double)3.0F, y - (double)2.0F, z + (double)offset);
            buffer.pos(x + (double)3.0F, y + (double)3.0F, z + (double)offset);
            tessellator.draw();
            GlStateManager.popMatrix();
         ...
         buffer.pos(x - (double)2.0F, y + (double)3.0F, z + (double)offset).tex(1.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x - (double)2.0F, y - (double)2.0F, z + (double)offset).tex(1.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)3.0F, y - (double)2.0F, z + (double)offset).tex(0.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)3.0F, y + (double)3.0F, z + (double)offset).tex(0.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         tessellator.draw();
         GlStateManager.popMatrix();
      }
   ...
   public void drawPlaneZNeg(double x, double y, double z, float f, int height) {
      ...
      if (this.inrange) {
         ...
         buffer.pos(x - (double)2.0F, y - (double)2.0F, z + (double)offset).tex(1.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x - (double)2.0F, y + (double)3.0F, z + (double)offset).tex(1.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)3.0F, y + (double)3.0F, z + (double)offset).tex(0.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)3.0F, y - (double)2.0F, z + (double)offset).tex(0.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         tessellator.draw();
         GlStateManager.popMatrix();
      }
   ...
   public void drawPlaneXPos(double x, double y, double z, float f, int height) {
      ...
      if (this.inrange) {
         for(int i = 0; i < 16; ++i) {
            ...
            buffer.pos(x + (double)offset, y + (double)3.0F, z - (double)2.0F);
            buffer.pos(x + (double)offset, y + (double)3.0F, z + (double)3.0F);
            buffer.pos(x + (double)offset, y - (double)2.0F, z + (double)3.0F);
            buffer.pos(x + (double)offset, y - (double)2.0F, z - (double)2.0F);
            tessellator.draw();
            GlStateManager.popMatrix();
            GL11.glMatrixMode(5888);
         }
         ...
         buffer.pos(x + (double)offset, y + (double)3.0F, z - (double)2.0F).tex(1.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)offset, y + (double)3.0F, z + (double)3.0F).tex(1.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)offset, y - (double)2.0F, z + (double)3.0F).tex(0.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)offset, y - (double)2.0F, z - (double)2.0F).tex(0.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         tessellator.draw();
         GlStateManager.popMatrix();
      }
   ...
   public void drawPlaneXNeg(double x, double y, double z, float f, int height) {
      ...
      if (this.inrange) {
         ...
         buffer.pos(x + (double)offset, y - (double)2.0F, z - (double)2.0F).tex(1.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)offset, y - (double)2.0F, z + (double)3.0F).tex(1.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)offset, y + (double)3.0F, z + (double)3.0F).tex(0.0F, 0.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         buffer.pos(x + (double)offset, y + (double)3.0F, z - (double)2.0F).tex(0.0F, 1.0F).color(0.5F, 0.5F, 0.5F, 1.0F)
        .endVertex();
         tessellator.draw();
         GlStateManager.popMatrix();
      }
